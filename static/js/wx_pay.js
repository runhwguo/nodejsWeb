...
function getCode() {
  ...
  const URL_OPEN_ID_CODE = `https://open.weixin.qq.com/connect/qrconnect?appid=${ APP_ID }&redirect_uri=${ REDIRECT_URI }&response_type=code&scope=snsapi_base&state=getCode#wechat_redirect`;
  $.get(URL_OPEN_ID_CODE, result => {
    alert(result);
  });
  alert('get code');
}
